...
Session 09 records MCP servers. Session 10 secures their runtime path.
...
| Work | Owner |
|---|---|
| Session 09 | Register the MCP server and its inventory metadata |
| Session 10 | Set runtime authorization, tool boundaries, and telemetry |
...
1. The MCP server passes the Session 10 decision.
...
| Runtime and security owners | Session 10 access and tool controls |
