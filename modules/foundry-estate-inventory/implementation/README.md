# Implementation - Foundry estate inventory across subscriptions
...
This module sits outside the numbered sequence and follows Sessions 01, 03, and 11.
...
someone creates a subscription, which is the case this module exists to catch.
...
the definition through this module and deploy it again. Remove the tagged workbook only after the
owner confirms no review process still uses it. To stop running the module, remove the report from
