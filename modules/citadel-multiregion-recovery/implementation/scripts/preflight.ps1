...
if ($control.schemaVersion -ne 2 -or $regional.schemaVersion -ne 2 -or
    [string]$control.implementationSession -cne "optional-module-citadel-multiregion-recovery" -or
    [string]$regional.implementationSession -cne "optional-module-citadel-multiregion-recovery") {
