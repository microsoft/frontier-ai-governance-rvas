# Microsoft Agent 365 access and data controls
...
- [Governance and lifecycle actions for agents](https://learn.microsoft.com/microsoft-365/admin/manage/agent-actions)
- [Use Microsoft Purview to manage data security and compliance for Microsoft Agent 365](https://learn.microsoft.com/purview/ai-agent-365)
...
- A supported nonproduction agent appears in Agent Registry with **Available** status and supports
  ...
  approved lifecycle path. The runtime owner is named. Complete Session 03 before this module
  for a Foundry agent.)
...
| Type | File | Consumer |
|---|---|---|
| Deployment | [`artifacts/agent-deployment.json`](artifacts/agent-deployment.json) | Microsoft 365 administrator and module preflight scripts |
| Record | [`artifacts/governance/coverage-handoff.md`](artifacts/governance/coverage-handoff.md) | data, Agent 365, source-platform, and audit owners |
| Runtime | [`artifacts/operations/agent-activity-audit-query.json`](artifacts/operations/agent-activity-audit-query.json) | Agent 365 audit-query scripts |
