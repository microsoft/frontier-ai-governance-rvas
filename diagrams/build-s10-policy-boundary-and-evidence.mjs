...
els.push(text(40, 58, 1500, "The gateway applies shared controls at the network boundary; an in-process govern() checks the tool action before it runs. Both can work together, but one does not prove the other.", C.neutral, { size: 14, align: "left" }));
