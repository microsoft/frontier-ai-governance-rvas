// S10 - End-to-end traceability across gateway, orchestration, execution, data/tool, monitoring, and operating decision.
import { C, text, node, connect, arrow, write } from "./lib.mjs";

const els = [];
els.push(text(40, 24, 1500, "S10 · End-to-end traceability flow", C.eval, { size: 26, align: "left" }));
els.push(text(
  40,
  60,
  1500,
...
write(new URL("./s10-end-to-end-traceability-flow.excalidraw", import.meta.url).pathname, els);
