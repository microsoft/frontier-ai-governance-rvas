...
els.push(text(40, 60, 1500, "A planning view for platform, publication, assurance, and operations decisions. It names reviewable planes and evidence routes; it is not proof of a deployed topology.", C.neutral, { size: 14, align: "left" }));
