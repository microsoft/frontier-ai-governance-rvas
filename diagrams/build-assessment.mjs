...
// ---- Title ----
els.push(text(60, 24, 900, "How the S0 baseline becomes a session plan", C.found, { size: 26, align: "left" }));
els.push(text(60, 60, 900, "Fill one instrument, run one script, then agree the priority sessions with the customer.", C.neutral, { size: 15, align: "left" }));
...
els.push(labelIn(700, 304, 250, 78, "Prioritized session plan\n(agree what comes first)", C.start, { size: 16 }));
...
els.push(text(716, 424, 450,
  "Priority recommendation (lowest maturity first):\n  1. S2 Data & Compliance  (maturity 2.00, gap 2.00)\n  2. S1 Identity & Access  (maturity 2.00, gap 2.00)\n  3. S3 Security Posture & Runtime  (maturity 2.33)\n  Customer and CoE confirm the delivery order.", dark,
