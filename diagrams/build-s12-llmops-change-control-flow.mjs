// S12 - LLMOps change control package: change card -> lifecycle artifacts -> manifest -> rollout/feedback.
import { C, text, node, connect, arrow, write } from "./lib.mjs";

const els = [];

els.push(text(40, 24, 1500, "S12 · LLMOps change control package", C.hero, { size: 26, align: "left" }));
els.push(text(
  40,
  60,
  1500,
...
write(new URL("./s12-llmops-change-control-flow.excalidraw", import.meta.url).pathname, els);
