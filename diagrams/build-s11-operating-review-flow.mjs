// S11 - Operating review package: review card -> coverage -> correlation/retention -> routes -> validation/recurrence.
import { C, text, node, connect, arrow, write } from "./lib.mjs";

const els = [];
els.push(text(40, 24, 1500, "S11 · Operating review package", C.data, { size: 26, align: "left" }));
els.push(text(
  40,
  60,
  1500,
