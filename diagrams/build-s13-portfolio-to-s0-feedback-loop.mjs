// S13 - Portfolio decision package: review card -> lineage -> scorecard -> prioritization -> roadmap/baseline.
import { C, text, node, connect, arrow, write } from "./lib.mjs";

const els = [];

els.push(text(40, 24, 1500, "S13 · Portfolio decision package", C.hero, { size: 26, align: "left" }));
els.push(text(
  40,
  60,
  1500,
