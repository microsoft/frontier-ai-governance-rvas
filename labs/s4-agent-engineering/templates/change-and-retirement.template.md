# Agent Change and Retirement Record
...
| Closure activity | Accountable owner | Approved record reference or completion status |
|---|---|---|
...
| Field | Record |
|---|---|
| Decision: reapprove / defer / reject change / retire | |
| Conditions, dependencies, and explicit exclusions | |
| Next review or closure date | |
