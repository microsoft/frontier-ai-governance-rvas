...
This offline kit supports one safe activity: review and record an admission
decision for a bounded agent candidate. It is evidence-first and report-only.
It does not generate customer code, prescribe a framework, connect to live
systems, implement a change, or grant production approval.
...
| Template | Use |
|---|---|
| [`templates/admission-record.template.md`](templates/admission-record.template.md) | Classify a candidate, record its implementation path, owners, requirements, test references, lifecycle-entry decision, and review date. |
