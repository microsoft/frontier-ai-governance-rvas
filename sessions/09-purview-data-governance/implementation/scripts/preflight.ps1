...
Write-Host "PASS: Session 09 accepts the supplied tenant and agent scope, validates the payload-free audit query, and leaves Purview state in Microsoft Purview."
