...
Purview does not show this ownership split in one view. This record assigns the owners across
products. Do not copy service state, simulation results, findings, or approval records here.

| Field | Value |
|---|---|
| Maintained by | Data governance owner |
| Reviewed by | Information protection, Agent 365, source-platform, and audit owners |
| Consumer | The Purview change path and quarterly cross-product control review |
...
| Selected agent publication and runtime | Microsoft Foundry, Copilot Studio, or Agent Builder, as recorded in `agent-deployment.json` | Source-platform owner |
...
The Agent 365 DLP policy governs the selected agent's use in Microsoft 365. Source-platform
runtime controls remain in Microsoft Foundry, Copilot Studio, or Agent Builder.
