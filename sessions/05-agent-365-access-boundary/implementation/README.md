...
- A supported nonproduction agent appears in Agent Registry with **Available** status and supports
  ...
  approved lifecycle path. The runtime owner is named. (See [Governed agent baseline guide](../../04-governed-agent-baseline/implementation/README.md)
  for a Foundry agent.)
...
| Type | File | Consumer |
|---|---|---|
| Deployment | [`artifacts/agent-deployment.json`](artifacts/agent-deployment.json) | The Microsoft 365 administrator and Session 05 preflight scripts |
