...
if ([string]$attackPlan.implementationSession -ne "10-red-teaming-threat-defense" -or
...
if ($LASTEXITCODE -ne 0) {
    throw "Install the Session 10 Python dependencies: python -m pip install -r `"$PSScriptRoot\requirements.txt`""
}
