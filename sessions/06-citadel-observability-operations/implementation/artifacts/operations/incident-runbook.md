...
This runbook covers the Session 06 service path: gateway, model, agent, tool, evaluation signals,
...
- Keep the Session 04 independent tool authorization boundary enforced.
- Inspect the correlated trace and Session 05 evaluation and red-team records in their governed
  systems.
...
- The credential owner uses the approved secret-management process; never place credentials in
  incident notes.
- Before restoring the tool, the identity owner confirms the Session 03 agent identity and the
  Session 04 access contract. The data, security, and service owners repeat the applicable Session
  05 checks.
...
- Run the approved Session 05 evaluation against the candidate replacement.
