...
The control points to Session 11's active threshold policy, enabled release policy, approved
baseline, matching candidate, and generated `blocked-tool-process` self-test. Session 12's report
