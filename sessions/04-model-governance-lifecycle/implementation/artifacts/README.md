...
- `models/deployment-profiles.json` is the deployment desired state read by `main.bicep` and
  checked by preflight. It carries the external approval reference and the control inputs needed
  to safely apply that approved deployment.
