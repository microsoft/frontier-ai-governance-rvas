...
Keep or restore the stable endpoint at 100% of the [Session 06](../../../../06-governed-agent-baseline/implementation/README.md) approved agent version. Do not pin the
...
[Session 09](../../../../09-mcp-tool-security/implementation/README.md) tool path, or customer data as a restore shortcut. A failed candidate remains unpinned
