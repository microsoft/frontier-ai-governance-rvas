...
| `governance/gateway-control.json` | Customer-owned limits, identity, safety, routing, ownership, and cache decision |
| `governance/model-routing-decision.md` | Owner-approved routing modes, model compatibility, data residency, PTU or pay-as-you-go fallback, token-counter behavior, secondary-route restore, Foundry-native AI Gateway awareness, and unified model API preview boundary |
