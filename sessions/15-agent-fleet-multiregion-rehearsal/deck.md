...
| Restore | Move the approved selector and keep the secondary deployment | Narrows the restore and leaves standby ready | Session 14 controls drift; capacity cost continues |

<!-- Notes: Session 14 promotes regional configuration. Session 15 moves traffic and checks the active path. -->
...
The Session 15 control definition names:
