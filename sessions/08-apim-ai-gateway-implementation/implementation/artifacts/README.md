...
| `gateway/policies/policy.xml` | Checks ingress identity and applies limits, safety, backend identity, retry, telemetry, and response controls |
| `governance/gateway-control.json` | Records the deployment values for limits, identity, safety, routing, ownership, and cache settings |
