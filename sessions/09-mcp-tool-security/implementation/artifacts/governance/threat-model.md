...
The [Session 04](../../../../04-governed-agent-baseline/implementation/README.md) policy assistant calls the Session 09 MCP endpoint in the
[Session 07](../../../../07-apim-ai-gateway-implementation/implementation/README.md) API Management instance. APIM maps `get_policy` to the existing GET operation. The
...
|---|---|---|---|---|
| User to agent | Approved nonproduction user group | Session 04 agent endpoint | Existing agent consumer access | Project administration |
...
Keep the Session 04 version pinned while testing. If either check fails, leave the stable endpoint
unchanged. If the candidate is already active, restore the previous Session 04 version at 100%
