...
if ($LASTEXITCODE -ne 0) {
    throw "Session 10 preflight failed."
}
...
$deployment = & az deployment group create `
    --name "session10-mcp-tool-security" `
