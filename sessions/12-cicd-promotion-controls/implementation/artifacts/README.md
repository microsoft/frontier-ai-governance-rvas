...
The [implementation guide](../README.md) is the operator runbook. This file maps the
source-controlled definitions and machine contracts used by the validators and GitHub Actions workflows.
...
to the approved release store after production routing. Manual restore reads that record.
