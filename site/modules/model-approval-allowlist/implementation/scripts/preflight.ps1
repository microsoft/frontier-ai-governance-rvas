...
if ($register.implementationModule -ne "model-approval-allowlist") {
    throw "The register has the wrong implementationModule marker."
}
if ($register.implementationSession -ne "model-approval-allowlist") {
