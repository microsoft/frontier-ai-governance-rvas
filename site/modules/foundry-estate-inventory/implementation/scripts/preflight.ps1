...
if ($scope.implementationModule -ne "foundry-estate-inventory") {
    throw "The estate scope record has the wrong implementationModule marker."
}
if ($scope.implementationSession -ne "foundry-estate-inventory") {
