...
These artifacts hold the Session 11 source-controlled configuration and retained Markdown records.
...
operator and correlation queries. The named Session 12 GitHub promotion workflow runs the paired
