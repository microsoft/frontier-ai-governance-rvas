...
1. **Set the room and orient** *(20 min)* — use `labs/s8-red-teaming/runbook.md` to confirm authorization, rules of engagement, SOC window, target label, stop conditions, and evidence boundary. The facilitator asks: **"Is this exact target customer-owned and non-production?"**, **"Who can stop the run?"**, and **"Which scorecard and decision records will the customer keep?"** Stop at pre-flight if any answer is missing or uncertain.
