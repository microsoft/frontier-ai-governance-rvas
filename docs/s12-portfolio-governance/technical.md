...
![S12 portfolio decision flow: portfolio review card, source-lineage and coverage package, scorecard, exception concentration, dependency clusters, prioritization, roadmap action, baseline feedback trigger, blocked gaps, and safe evidence boundary.](../assets/diagrams/s12-portfolio-to-s0-feedback-loop.svg)
...
- [S12 Concepts](concepts.md): portfolio decision view, source lineage, scorecards, exception concentration, dependency clusters, prioritization, and baseline feedback.
