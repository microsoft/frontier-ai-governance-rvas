...
| Evaluation | evaluation record, safety/quality/cost/latency thresholds, regression tolerance | Route to the evaluation owner when thresholds, baseline, evaluator version, or exception owner is missing. |
...
| Evaluation | evaluation reference, thresholds, evaluator version, baseline, exception owner, and limitation |
...
| Evaluation dependency | evaluation record has evaluator version, thresholds, baseline, exception owner, and limitations | Evaluation owner |
...
- **Defer** when records, owners, baseline/candidate/fallback state, evaluation, monitoring, rollback, retirement, or automation prerequisites are missing. Include owner, target date, acceptance test, and review trigger.
