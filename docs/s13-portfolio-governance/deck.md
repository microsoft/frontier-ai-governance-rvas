...
Boundary: S13 prepares a portfolio decision package. It does not create
...
![S13 portfolio decision package: review card, source lineage, scorecard, exception concentration, dependency clusters, prioritization, roadmap action, baseline feedback, blocked gaps, and safe references.](../assets/diagrams/s13-portfolio-to-s0-feedback-loop.svg)
...
Note:
S13 can prepare a funding package. It cannot approve funding.
