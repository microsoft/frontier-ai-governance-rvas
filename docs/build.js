...
const SESSIONS = [
  { slug: 's0-foundations', code: 'S0', phase: 'Govern', accent: '#032254', persona: 'Governance lead', nist: 'Govern · Map', outcome: 'Governance operating-model decision + first backlog', services: ['agent-365', 'copilot-studio', 'microsoft-teams', 'microsoft-purview'] },
  { slug: 's1-identity', code: 'S1', phase: 'Govern', accent: '#1A77E3', persona: 'Identity admin', nist: 'Govern · Map · Manage', outcome: 'Agent identity and authority decision + implementation handoff', services: ['microsoft-entra-id', 'microsoft-entra-agent-id', 'microsoft-entra-workload-id', 'agent-365', 'azure-key-vault', 'azure-api-management'] },
  { slug: 's2-data-compliance', code: 'S2', phase: 'Govern', accent: '#14868A', persona: 'Compliance / Data admin', nist: 'Map · Manage', outcome: 'Data-use and enforcement decision + evidence handoff', services: ['microsoft-purview', 'azure-ai-content-safety', 'sharepoint', 'azure-api-management', 'application-insights'] },
  { slug: 's3-platform-foundation', code: 'S3', phase: 'Establish', accent: '#0F766E', persona: 'Platform owner', nist: 'Govern · Map · Manage', outcome: 'Platform readiness decision + implementation work package', services: ['azure-ai-foundry', 'azure-openai', 'azure-ai-search', 'azure-api-management', 'azure-api-center', 'azure-container-apps', 'azure-kubernetes-service', 'log-analytics', 'microsoft-purview'] },
  { slug: 's4-agent-engineering', code: 'S4', phase: 'Establish', accent: '#7C3AED', persona: 'AI developer / maker', nist: 'Govern · Map · Measure', outcome: 'Agent admission and promotion decision + build handoff', services: ['foundry-agent-service', 'copilot-studio', 'microsoft-365-copilot', 'agent-365', 'power-automate', 'azure-api-management', 'application-insights', 'microsoft-purview'] },
  { slug: 's5-tool-api-governance', code: 'S5', phase: 'Establish', accent: '#C2410C', persona: 'Platform owner', nist: 'Govern · Map · Manage', outcome: 'Tool/API publication decision + controlled handoff', services: ['azure-api-management', 'azure-api-center', 'microsoft-entra-id', 'azure-ai-content-safety', 'copilot-studio', 'azure-policy', 'microsoft-purview'] },
  { slug: 's6-security-runtime', code: 'S6', phase: 'Assure', accent: '#DC2626', persona: 'Security / SOC', nist: 'Measure · Manage', outcome: 'Runtime enforcement decision + acceptance evidence', services: ['microsoft-defender-for-cloud', 'microsoft-defender-xdr', 'microsoft-sentinel', 'azure-api-management', 'azure-monitor', 'application-insights', 'azure-ai-content-safety', 'microsoft-purview'] },
  { slug: 's7-evaluation', code: 'S7', phase: 'Assure', accent: '#504092', persona: 'AI developer / maker', nist: 'Measure · Manage', outcome: 'Evaluation and release-gate decision + evidence package', services: ['azure-ai-foundry', 'azure-ai-content-safety', 'azure-load-testing', 'application-insights', 'azure-monitor', 'microsoft-teams', 'microsoft-purview'] },
  { slug: 's8-red-teaming', code: 'S8', phase: 'Assure', accent: '#EA580C', persona: 'Security / SOC', nist: 'Govern · Measure · Manage', outcome: 'Adversarial finding decision + remediation handoff', services: ['microsoft-defender-for-cloud', 'microsoft-defender-xdr', 'microsoft-sentinel', 'azure-ai-foundry', 'azure-ai-content-safety'] },
  { slug: 's9-control-plane', code: 'S9', phase: 'Operate', accent: '#0078D4', persona: 'Governance lead', nist: 'Govern · Map · Manage', outcome: 'Control-plane record and lifecycle decision + cadence', services: ['microsoft-entra-id', 'microsoft-entra-agent-id', 'azure-ai-foundry', 'azure-api-management', 'azure-api-center', 'azure-monitor', 'application-insights', 'microsoft-teams', 'microsoft-purview'] },
  ...
  { slug: 's11-operate-measure', code: 'S11', phase: 'Operate', accent: '#7C3AED', persona: 'Governance lead', nist: 'Govern · Measure · Manage', outcome: 'Workload operating-review decision + remediation handoff', services: ['microsoft-defender-for-cloud', 'azure-ai-foundry', 'azure-monitor', 'log-analytics', 'application-insights', 'azure-cost-management', 'microsoft-purview'] },
  { slug: 's12-llm-operations', code: 'S12', phase: 'Operate', accent: '#2563EB', persona: 'LLMOps owner', nist: 'Govern · Map · Measure · Manage', outcome: 'End-to-end LLMOps lifecycle decision + implementation backlog', services: ['azure-ai-foundry', 'azure-api-management', 'azure-monitor', 'log-analytics', 'application-insights', 'microsoft-teams'] },
  { slug: 's13-portfolio-governance', code: 'S13', phase: 'Operate', accent: '#475569', persona: 'Executive sponsor', nist: 'Govern · Map · Measure · Manage', outcome: 'Portfolio triage decision + dated governance roadmap', services: ['agent-365', 'azure-ai-foundry', 'azure-api-center', 'azure-monitor', 'application-insights', 'azure-cost-management', 'microsoft-teams', 'microsoft-purview'] },
];
