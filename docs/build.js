...
const PAGES = [
  ...
  { slug: 'start-maturity-model',         src: 'start/maturity-model.md',     title: 'Operational maturity model', nav: true, group: 'Start here' },
...
const ROUTES = {
  ...
  'start/maturity-model.md': 'page.html?p=start-maturity-model',
