...
const SESSIONS = [
  ...
  { slug: 's10-in-process-governance', code: 'S10', phase: 'Operate', accent: '#0891B2', persona: 'AI developer / maker', nist: 'Govern · Measure · Manage', outcome: 'In-process tool-call control decision + engineering handoff', services: ['azure-api-management', 'azure-logic-apps', 'application-insights'] },
  ...
  { slug: 's12-llm-operations', code: 'S12', phase: 'Operate', accent: '#2563EB', persona: 'LLMOps owner', nist: 'Govern · Map · Measure · Manage', outcome: 'LLMOps change-control decision + implementation backlog', services: ['azure-ai-foundry', 'azure-api-management', 'azure-monitor', 'log-analytics', 'application-insights', 'microsoft-teams'] },
